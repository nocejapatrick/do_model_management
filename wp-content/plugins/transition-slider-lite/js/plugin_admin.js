...
(function($) {
    $(document).ready(function() {
        ...
        addOption("size", "forceResponsive", "checkbox", "Force responsive mode", false, "", "isSubitem", "", "desktop");
		addOption("size", "fullscreen", "checkbox", "Fullscreen mode", false, "", "hasSubitem", "", "desktop");
		addOption("size", "forceFullscreen", "checkbox", "Force fullscreen mode", false, "", "isSubitem", "", "desktop");
		addOption("size", "sliderSize", "textOnly", "Fixed mode", "", "", "hasSubitem", "");
        addOption("size", "width", "textWithUnit", "Width", "1000", "px", "isSubitem", "", "desktop");
        ...
        function updateElementSettings(obj, hover) {
            ...
            updateContentAnimationType(getContentAnimationType());
